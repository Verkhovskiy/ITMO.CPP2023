...
class Student
{
    ...
    {
        for (int i = 0; i < 5; ++i) {
            if(student_scores[i] > 5) throw ExScore("in set_scores() function", student_scores[i]);
...
int main()
{
    ...
    {
        cout << "\nInitialization mistake " << ex.origin;
        cout << "\nThe score value " << ex.iValue << " is not acceptable\n";
    }
