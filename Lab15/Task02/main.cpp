...
int main()
{
    ...
    Student* student03 = new Student("Peter", "Petrov", idc2);
    Student* student04 = new Student("Igor", "Igorev", idc);
    Student* student05 = new Student("Sasha", "Kogan", idc2);
    Student* student06 = new Student("Dmitri", "Ivanov", idc);
